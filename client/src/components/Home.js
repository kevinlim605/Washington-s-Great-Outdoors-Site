      ...
      <Row className="mt-5">
        <Col xs={{ size: 12 }} lg={{ size: 6 }} className="mb-3 my-auto">
          ...
          <p>
            ...
            mollis ipsum, non tincidunt sapien sodales sit amet. Nunc placerat
            lorem non congue semper.
          </p>
        </Col>
        <Col
          lg={{ size: 6 }}
          className="my-auto d-flex justify-content-lg-end justify-content-center"
        >
