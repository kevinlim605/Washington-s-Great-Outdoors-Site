...
function Home() {
    return( 
        <Container>
            ...
            <Row className="mt-5">
                <Col xs={{size: 12}} lg={{size: 6}} className="mb-3 my-auto">
                    <h1 className="text-center text-lg-left">Find Your Next Adventure!</h1>
                ...
                <Col lg={{size: 6}} className="my-auto d-flex justify-content-lg-end justify-content-center"> 
                    {/* <img src="/images/homepicture1.jpg" className="img-thumbnail"/> */}
                    <img src="/images/homepicture1.jpg" className="rounded" height="320" width="500"/>
                </Col>
            </Row>
            <Row className="mt-5">
            ...
            <Row className="mt-4">
                <Col xs={{order: 2}} lg={{size: 6, order: 1}} className="d-flex justify-content-center justify-content-lg-start"> 
                    <img src="/images/homepicture2.jpg" className="rounded"/>
                </Col>
            ...
            <Row className="mt-4">
                ...
                <Col lg={{size: 6}} className="d-flex justify-content-lg-end justify-content-center"> 
                    <img src="/images/homepicture3.jpg" className="rounded"/>
                </Col>
            </Row>
        </Container>
    )
