export const ACTIVITIES = [
    {
        id: 0,
        name: "Hiking",
        description: "Hike across mountainous, scenic trails found abundant throughout the pacific northwest.",
    ...
    },
    {
        id: 2,
        name: "Kayaking",
        description: "Feel the pleasant waters around you as you glide across some of the most gorgeous scenes",
