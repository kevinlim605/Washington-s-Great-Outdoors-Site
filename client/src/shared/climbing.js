export const CLIMBING = [
  ...
  },
  {
    ...
    description:
      'Mount Rainier needs little introduction. Rising from the continental shelf of the Pacific to an impressive 14,411ft, this volcano (yes, an active volcano) dominates everyone’s skyline from Everette to Olympia. It is so big, Mount Rainier creates its own weather, which should be top of mind for climbers once standing at its base. Weather determines how long you can be up there until the mountain’s mood changes.',
